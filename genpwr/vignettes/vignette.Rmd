...
* Power Calculation for a study case control study with 400 subjects, including 160 cases and 240 controls (case rate of 40%) over a range of minor allele frequencies from 0.05 to 0.1.  We calculate power to detect an odds ratio of 4 for all potential true and test models.     
