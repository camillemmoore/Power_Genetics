...
The genpwr package for R (>3.3.2) performs power and sample size calculations     
...
* Install R version 3.3.2 or higher by following the instructions at http://www.r-project.org
